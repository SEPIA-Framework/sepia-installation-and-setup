...
echo '| '
echo '| The container will look for "$SEPIA_SHARE/automatic-setup/docker-setup" at start-up and enter'
echo '| automatic-setup mode EVERY time as long as the file still exists.'
echo '| Check "$SEPIA_SHARE/automatic-setup/results.log" afterwards to see the results.'
echo '| '
