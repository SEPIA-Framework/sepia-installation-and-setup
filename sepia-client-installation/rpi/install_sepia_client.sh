...
echo ""
echo "When the client has been started you should hear a voice saying 'just a second' followed"
echo "by 'ready for setup' after loading was completed. Then can use the touchscreen or the"
echo "SEPIA Control HUB (for headless mode) to log in and enjoy your new SEPIA Client :-)"
